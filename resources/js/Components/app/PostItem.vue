    ...
    <div class="bg-white border rounded p-4 shadow mb-3">
        <div class="flex items-center gap-2 mb-3">
            <a href="javascript:void[0]">
                <img :src="post.user.avatar" alt="" class="w-[40px] rounded-full aspect-square border border-2 hover:border-blue-500 transition-all"> 
            </a>
            <div>
                <h4 class="font-bold">
        ...
        <div class="mb-3">
            <Disclosure v-slot="{ open }">
                <div v-if="!open" v-html="post.body.substring(0, 10)" />
                <DisclosurePanel>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 mb-3">
            <template v-for="attachment of post.attachments" >
                ...
                <div class="group bg-blue-100 aspect-square flex flex-col items-center justify-center text-gray-500 relative">
                    <!-- download -->
                    <button class="opacity-0 group-hover:opacity-100 transition-all w-8 h-8 flex items-center justify-center text-gray-100 bg-gray-700 hover:bg-gray-800 rounded absolute right-2 top-2 cursor-pointer">
